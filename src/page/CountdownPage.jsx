    ...
    return (
      <div className='countdown-banner' id='section-countdown'>
        <div className='container text-center'>
          <img className='frame mb-4' src={""} alt="" />
          <h1 className='playball mb-5'>Countdown</h1>

          <div className='card-countdown'>
            <h3 className=''>Until 27 March 2022</h3>
            <Countdown date={new Date(2022,8,27)} renderer={renderer} />
          </div>
          <a target="_blank" rel="noreferrer" href={`https://www.google.com/calendar/render?action=TEMPLATE&text=KalanantiGrandLaunchinng&dates=20220313T${ data.sesi == '1' ? '103000' : '120000'}/20220313T${ data.sesi == '1' ? '120000' : '133000'}`} className="btn btn-slide-pink btn-sm mt-5">Save The Date</a>
        </div>
      </div>
    )
